...
public class UsersGenerator {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("src/json_files/Users.json"))) {
            long numberOfUsers = 1000000;

            bufferedWriter.write("[");
            bufferedWriter.write(
                    "{\"Type\":\"Master\",\"Email\":\"root@root.user.com\",\"Nickname\":\"Root\",\"Password\":\"root\"},");

            for (int i = 0; i < numberOfUsers; i++) {
                bufferedWriter.write("{\"Type\":\"None\",\"Email\":\"" + nuevocorreo() + "@user.com\",\"Nickname\":\""
                        + nuevonickname() + "\",\"Password\":\"" + nuevacontraseña() + "\"},");
            }

            bufferedWriter.write(
                    "{\"Type\":\"Master\",\"Email\":\"master@root.user.com\",\"Nickname\":\"Master\",\"Password\":\"login\"}");
            bufferedWriter.write("]");
        } catch (IOException e) {
            // Exception handling
        }
